...
slug: "battery-dead-but-lights-turn-on"
---
...
1. **Try a jump start first.** This confirms whether the battery is the issue. If the car starts after a jump, the battery is weak or failing.
2. **Drive to an auto parts store immediately.** Most stores (AutoZone, O'Reilly, Advance Auto) test your battery and alternator for free. Do not turn the car off until you arrive.
3. **If it won't start after a jump**, the problem is likely the starter motor, not the battery. The jump confirmed the battery has some charge, the starter isn't engaging.
4. **Check battery terminals.** Look for loose connections or heavy corrosion (white/blue-green buildup). A corroded terminal causes exactly this symptom, lights work, car won't start.
5. **If terminals are corroded**, clean them with a wire brush or terminal cleaner spray, reconnect firmly, and try again.
6. **If the car clicks when you turn the key**, read the clicking article, one click is usually the starter solenoid, rapid clicks are low battery.

### Why Lights Work But the Car Won't Start

The starter motor draws 80–200 amps when cranking. Your headlights draw about 10 amps. A battery sitting at 11.5 volts can power lights all day but can't deliver the surge current the starter needs. This is the most common reason for this symptom.
...
| Fix | Typical Cost |
|---|---|
| Battery replacement | $100 – $220 installed |
| Terminal cleaning | $20 – $50 at a shop |
| Starter replacement | $300 – $600 |
| Ground cable replacement | $50 – $150 |
...
- **In cold weather**, battery capacity drops significantly. A battery at 20°F might start fine in summer but fail completely in winter. Cold-weather failures are common in older batteries.
